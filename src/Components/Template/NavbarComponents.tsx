...
const NavbarComponents = () => {
  ...
  return (
    <header className="container navbar navbar-elevated p-fixed">
      <section className="navbar-section ">
        {closeBtn ? <a className="off-canvas-toggle btn btn-link btn-action" href="#sidebar-id" onClick={() => setCloseBtn(!closeBtn)}>
          <i className="icon icon-cross"></i>
        </a> : <a className="off-canvas-toggle btn btn-link btn-action" href="#close" onClick={() => setCloseBtn(!closeBtn)}>
          <i className="icon icon-menu"></i>
        </a>}
